...
function Contact() {
    ...
    const onSubmit = async (event) => {
        ...
        formData.append("access_key", "2736885e-f66e-414e-b24d-9775f4cca181");
    ...
    return (
        <div id='contact' className='w-full px-[12%] py-10 scroll-mt-20 bg-[url("/footer-bg-color.png")] bg-no-repeat bg-center bg-[length:90%_auto]'>
            ...
            <h2 className='text-center text-5xl font-Ovo text-violet-600'> Get in touch </h2>
            ...
            <form onSubmit={onSubmit} className='max-w-2xl mx-auto'>
                ...
                <textarea name='message' id="" rows='6' placeholder='Enter your message' required className='w-full p-4 outline-none border-[0.5px] border-gray-400 rounded-md bg-white mb-6'></textarea>
